...
const ManagerLogin: React.FC<ManagerLoginProps> = ({ onLogin, error }) => {
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-2">管理会社ログイン</h2>
            <p className="text-gray-600">担当物件の管理業務を行えます</p>
          </div>
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="text-sm text-gray-600 space-y-1">
              <p><strong>ユーザー名:</strong> manager</p>
              <p><strong>パスワード:</strong> manager123</p>
